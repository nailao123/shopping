  ...
  <header class="header">
    ...
    <div class="navbar">
      <div class="navbar-left-container">
        <a href="/"><img src="/static/logo.png" class="navbar-brand-logo" /></a>
      </div>
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          <!---->
          <span v-text="nickName" v-if="nickName"></span>
          <a href="javascript:;" @click="loginModalFlag=true" v-if="!nickName"  >Login</a>
          <a href="javascript:;" @click="logOut"  v-if="nickName"  >&nbsp;&nbsp;&nbsp;&nbsp;Logout</a>
          <a href="javascript:;"></a>
        ...
        <div class="md-content">
          <div class="confirm-tips">
            <div class="error-wrap">
              <span class="error error-show" v-show="errorTip" style="display: none;">用户名或者密码错误</span>
            </div>
            <ul>
